    ...
    public class DatabaseListViewModelTests : VMTestBase
    {
        ...
        public void Load_should_load_data_for_all_databases()
        {
            var containers = new List<Processor.Data.Models.ScriptContainer>() {
                     new Processor.Data.Models.ScriptContainer() {DatabaseName="DB1",ScriptContainerPath="C:\\DB1" },
                     new Processor.Data.Models.ScriptContainer() {DatabaseName="DB2",ScriptContainerPath="C:\\DB2" },
                     new Processor.Data.Models.ScriptContainer() {DatabaseName="DB3" ,ScriptContainerPath="C:\\DB3"}
             };
